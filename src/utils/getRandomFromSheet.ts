...
// Helper function to map restaurant image names to their correct paths
function getRestaurantImageMapping(imageName: string): string {
  if (!imageName || imageName === "default.png" || imageName === "") {
    return "";
  }

  // Map of restaurant image names to their uploaded image paths
